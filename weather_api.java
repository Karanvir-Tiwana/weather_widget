...
public class weather_api {
    ...
    // create an account at openweathermap.org and generate a free api key.
    // copy that API key and store it in the variable, API_key, below!
